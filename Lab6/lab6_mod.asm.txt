...
;opcodes
opcode1 dd 0E08B4Ch ; mov rax, r12 
opcode2 dq 0C87E0F4866h ; MOVD rax, xmm1
opcode3 dq 08C68348h	; ADD rsi, 8
opcode4 dd 0C1FF49h ; inc r9
opcode5 dd 0B4E2h ;loop
ifmt db "%s", 10, 10,"%s",0
...
; Self-Modification code part
invoke GetCurrentProcessId
invoke OpenProcess, PROCESS_VM_OPERATION or PROCESS_VM_WRITE, 1, eax
mov r15, rax ;

lea rdi, _chng1
invoke WriteProcessMemory, r15, rdi, addr opcode1, 3, 0
lea rdi, _chng2
invoke WriteProcessMemory, r15, rdi, addr opcode2, 5, 0
lea rdi, _chng3
invoke WriteProcessMemory, r15, rdi, addr opcode3, 4, 0
lea rdi, _chng4
invoke WriteProcessMemory, r15, rdi, addr opcode4, 3, 0
lea rdi, _chng5
invoke WriteProcessMemory, r15, rdi, addr opcode5, 2, 0
